...
const Formulario = ({ cliente, cargando }) => {
  ...
  return cargando ? (
    ...
    <div className="bg-white mt-10 px-5 py-10 rounded-md shadow-md md:w-3/4 mx-auto">
      ...
      <Formik
        initialValues={{
          nombre: cliente?.nombre ?? "", //nueva sintaxis parecida a ternario para comprobar si hay una propiedad...nullish coalescing operator
          ...
          return (
            <Form className="mt-10">
              ...
              <input
                ...
                className="mt-5 w-full cursor-pointer bg-blue-800 p-3 text-white uppercase font-bold text-lg"
              />
            </Form>
          );
        }}
